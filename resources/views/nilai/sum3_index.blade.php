                        ...
                        <div class="card-body px-0 pb-2">
                            ...
                            <div class="p-4">
                                @if(!request('id_kelas') || !request('id_mapel'))
                                    <p class="text-secondary mt-3 p-3 text-center border rounded">Pilih filter untuk menginput nilai Sumatif 3.</p>
                ...
                <form action="{{ route('master.sumatif.download') }}" method="GET"> 
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select name="id_kelas" required class="form-select ajax-select-kelas" data-target="#mapel_download_sum3">
                                <option value="">Pilih Kelas</option>
                                @foreach(\App\Models\Kelas::orderBy('nama_kelas')->get() as $k)
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_mapel" id="mapel_download_sum3" required class="form-select">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('master.sumatif.import') }}" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Kelas:</label>
                            <select name="id_kelas" required class="form-select ajax-select-kelas" data-target="#mapel_import_sum3">
                                <option value="">Pilih Kelas</option>
                                @foreach(\App\Models\Kelas::orderBy('nama_kelas')->get() as $k)
                                    <option value="{{ $k->id_kelas }}">{{ $k->nama_kelas }}</option>
                                @endforeach
                        ...
                        <div class="mb-3">
                            <label class="form-label">Mata Pelajaran:</label>
                            <select name="id_mapel" id="mapel_import_sum3" required class="form-select">
                                <option value="">Pilih Kelas Terlebih Dahulu</option>
                            </select>
                        </div>
                        <div class="mb-3">
